...
int main()
{
    ...
    // ------------------------------------
    char* headDir = "/Users/haoxiangliang/Desktop/代码草稿/OpenGL/OpenGL_Test27_SSAO(ScreenSpaceAmbientOcclusion)/OpenGL_Test27_SSAO(ScreenSpaceAmbientOcclusion)/";
    ...
    string p3 = string(headDir) + "LightShader/SSAO.vs";
    string p4 = string(headDir) + "LightShader/SSAO_Lighting.fs";
    Shader shaderLightingPass(p3.c_str(), p4.c_str());
    string p5 = string(headDir) + "LightShader/SSAO.vs";
    string p6 = string(headDir) + "LightShader/SSAO.fs";
    Shader shaderSSAO(p5.c_str(), p6.c_str());
    string p7 = string(headDir) + "LightShader/SSAO.vs";
    string p8 = string(headDir) + "LightShader/SSAO_Blur.fs";
    Shader shaderSSAOBlur(p7.c_str(), p8.c_str());
